...
def xiangtingshu_output(hand, raw_hand=True):
    ...
    xiangtingshu_14, num_youxiaopai, list_youxiaopai = cal_xiangtingshu(hand, raw_hand=False)
    ...
    for card, xiangtingshu, num_youxiaopai, list_youxiaopai in best_cards:
        ...
        for i in list_youxiaopai:
            youxiaopai += str(i) + ' '
        final_return.append('打{}: 向听数{}, 有效牌{}, {}种{}张'.format(card, 
            xiangtingshu, youxiaopai, 
            len(list_youxiaopai), num_youxiaopai))
    return final_return
